...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex">
            <div className="hidden lg:flex lg:w-1/2 bg-app-green relative justify-center items-center">
            ...
            <div className="flex-1 flex-center bg-app-cream px-4 py-12">
                <div className="w-full max-w-md ">
                    <div className="text-center mb-8">
                        <Link to="/" className="inline-flex items-center gap-2 mb-6">
                            <IconLeaf className="size-8 text-app-green" />
                        ...
                        <p className="text-sm text-app-text-light">
                            ...
                            <button
                                type="button"
                                className="text-orange-500 font-semibold hover:text-orange-600 transition-colors ml-1"
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <label className="text-sm flex flex-col gap-1">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-11 pr-4 py-3 text-sm bg-white rounded-xl border not-focus:border-app-border transition"
                                    />
                                </div>
                            </label>
                        )}
                        ...
                        <button type="submit" disabled={loading} className="flex-center w-full py-3 bg-green-950 text-white rounded-xl font-semibold hover:bg-green-900 transition-colors disabled:opacity-50">
                            {loading ? <Loader2Icon /> : isLoginState ? "Sign In" : "Sign Up"}
                        </button>
                    </form>
                </div>
            </div>
