...
import { ArrowLeftIcon, ArrowRightIcon, CheckIcon, HomeIcon, LeafIcon, MinusIcon, PlusIcon, ShoppingCartIcon, StarIcon } from "lucide-react";
        ...
        <div className="bg-white/50 rounded-2xl overflow-hidden">
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center">
              ...
              <div className="mb-6">
                {product.stock > 0 ? (
                  <span className="text-sm flex items-center text-app-success font-medium">
