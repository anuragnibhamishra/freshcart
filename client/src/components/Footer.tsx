                    ...
                    <div className="">
                        ...
                        <div className="flex gap-3">
                            {footerData.brand.socials.map((social, i) => (
                                <a key={i} href={social.link} className="size-9 rounded-lg bg-white/10 flex-center hover:bg-white/20 ">
                        ...
                        <div key={i}>
                            ...
                            <ul className="space-y-2.5">
                                {section.links.map((link, i) => (
                                    <li key={i}>
                                        {link.to ? <Link to={link.to} className="text-sm text-white/70 hover:text-white">{link.label}</Link> : (
                    ...
                    <div className="">
                        ...
                        <ul className="space-y-3">
                            {footerData.contact.map((item, i) => {
                                ...
                                return (
                                    <li key={i} className="flex gap-3 text-sm text-white/70"><Icon className="size-4 text-white " />{item.text}</li>
                                )
                            })}
                        </ul>
                    </div>
